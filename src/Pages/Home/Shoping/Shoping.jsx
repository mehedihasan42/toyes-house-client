...
const Shoping = () => {
    ...
    return (
      ...
      <div className='lg:w-2/3 lg:mx-auto'>
        <Tabs>
    <TabList className="lg:flex lg:flex-center ml-8 w-2/3 lg:w-96 lg:mx-auto my-8 space-x-2 lg:space-x-4">
      ...
      <Tab className="px-2 mt-2 lg:mt-0 lg:px-4 py-2 bg-gray-700 text-gray-200 rounded-md btn hover:btn-outline cursor-pointer transition-colors duration-300">Taddy Toyes</Tab>
    </TabList>
